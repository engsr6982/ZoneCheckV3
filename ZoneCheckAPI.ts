...
const APIs: ZoneCheckV3APIs = {};

function importZoneCheckV3APIs() {
  const ZoneCheckV3_NameSpace = "ZoneCheckV3";
  APIs.isWithinRadius = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker2D::isWithinRadius");
  APIs.isWithinRectangle = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker2D::isWithinRectangle");
  APIs.isWithinCenteredSquare = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker2D::isWithinCenteredSquare");
  APIs.isWithinSphere = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker3D::isWithinSphere");
  APIs.isWithinCuboid = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker3D::isWithinCuboid");
  APIs.isWithinCenteredCube = ll.imports(ZoneCheckV3_NameSpace, "RegionChecker3D::isWithinCenteredCube");
  APIs.getExceededBoundaryCircle2D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is2D::getExceededBoundaryCircle2D");
  APIs.getExceededBoundaryRectangle2D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is2D::getExceededBoundaryRectangle2D");
  APIs.getExceededCenteredBoundary2D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is2D::getExceededCenteredBoundary2D");
  APIs.getExceededBoundaryCircle3D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is3D::getExceededBoundaryCircle3D");
  APIs.getExceededBoundaryCube3D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is3D::getExceededBoundaryCube3D");
  APIs.getExceededCenteredBoundary3D = ll.imports(ZoneCheckV3_NameSpace, "BoundaryChecker::is3D::getExceededCenteredBoundary3D");
  APIs.getRandomCoordinateInCircle = ll.imports(ZoneCheckV3_NameSpace, "RandomAreaPosition::getRandomCoordinateInCircle");
  APIs.getRandomCoordinateInRectangle = ll.imports(ZoneCheckV3_NameSpace, "RandomAreaPosition::getRandomCoordinateInRectangle");
  APIs.getRandomCoordinateInSquare = ll.imports(ZoneCheckV3_NameSpace, "RandomAreaPosition::getRandomCoordinateInSquare");
  return true;
}
